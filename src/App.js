...
function App() {
  ...
  return (
    <html>
      ...
      <body style={{backgroundColor: '#ffcd82', display: 'flex', height: '100vh', overflow: 'hidden'}}>
        ...
        <div style={{margin: 'auto', position: 'relative', alignContent: 'center', paddingBottom: 100, display: 'inline-block'}}>
          ...
          <h1 style={{fontSize: 50}}>Кириенко Денис</h1>
            <div style={{paddingBottom: 50, fontSize: 35}}>Backend-разработчик</div>
            ...
            <text style={{fontSize: 20, paddingLeft: 20, verticalAlign: 'top'}}>+7 924 522 71 72&nbsp; &nbsp; &nbsp;
              <a href="mailto:kirienko.do@dvfu.ru">kirienko.do@dvfu.ru</a>
            </text>
